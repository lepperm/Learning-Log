...
progressionEntries: 
  ...
  - 
    ...
    item: http://eloquentjavascript.net/
    type: 
    relproj:
    relprojlink:
    datecomp:
  ...
  - 
    id: 
    status: NS
    name: avaScript clean code guide
    item: ttps://github.com/ryanmcdermott/clean-code-javascript
    type: 
    relproj:
    relprojlink:
    datecomp:
  ...
  - 
    id: 
    status: NS
    name: earning Git and GitHub
    item: ttps://www.lynda.com/Git-tutorials/Up-Running-Git-GitHub/409275-2.html
    type: 
    relproj:
    relprojlink:
    datecomp:
  ...
  - 
    id: 
    status: NS
    name: loquent JavaScript
    item: ttp://eloquentjavascript.net/
    type: 
    relproj:
    relprojlink:
    datecomp:
  ...
  - 
    ...
    status: NS
    name: earn CSS Grid
    item: ttps://scrimba.com/g/gR8PTE
    type: 
    relproj:
    relprojlink:
    datecomp:
